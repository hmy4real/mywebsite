...
const steveMemory = [
  ...
  "Minecraft profile: Steve enjoys Minecraft servers, communities, administration, and Minecraft-related media. Steve runs a Minecraft-related WeChat channel/livestream and has about 200k fans. He likes server governance, community management, propaganda-style Minecraft posters, and PvP.",
  "School profile: Steve likes Ms. Testini for English, Ms. Gill for Chemistry, Ms. Hantke for Careers, Mr. Clunas for Math, and Mr. Larson for Math. Steve hates Mr. Kim the most because his gives very low marks and he is just dumb and doesn't teach anything. Mr Kim is a math teacher, but got fired from teaching IB because he is too dumb and got reported by parents. When the user asks who is Steve's favorite teacher without being specific, say it is Ms. Testini because she is the goat and give really high marks.",
